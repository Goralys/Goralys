...
Routes::get('subjects/teacher', function (GoralysKernel $kernel) {
...
Routes::get('subjects/student', function (GoralysKernel $kernel) {
...
Routes::get('subjects/draft', function (GoralysKernel $kernel, RequestInterface $request) {
...
// [SUB SECTION] Student
// --------------------------------------------------
Routes::put('subjects/draft', function (GoralysKernel $kernel, RequestInterface $request) {
...
Routes::post('subjects/submit', function (GoralysKernel $kernel, RequestInterface $request) {
    $kernel->guard->matchCurrentUser($request, 'student')?->send();
